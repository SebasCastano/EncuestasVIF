...
class DatosMujeres(models.Model):
    ...
    a8a_tipo_discapacidad = models.CharField(max_length=100, choices=DISCAPACIDAD_CHOICES, blank=True)
    ...
    a12a_tipo_sustancia = models.CharField(max_length=100, choices=TIPO_SUSTANCIA_CHOICES, blank=True)
    a12b_otro_tipo_sustancia = models.CharField(max_length=100, blank=True)
    ...
    b2_otro_especificado = models.CharField(max_length=100, blank=True)
    ...
    b6_otro_especificado = models.CharField(max_length=100, blank=True)
    c1_relacion_agresor = models.CharField(max_length=100, choices=TIPO_RELACION_AGRESOR_CHOICES)
    c1_otro_especificado = models.CharField(max_length=100, blank=True)
    ...
    h_evento1 = models.CharField(max_length=200, default="Ninguno")
    h_evento2 = models.CharField(max_length=200, default="Ninguno")
    h_evento3 = models.CharField(max_length=200, default="Ninguno")
    h_evento4 = models.CharField(max_length=200, default="Ninguno")
    h_evento5 = models.CharField(max_length=200, default="Ninguno")
    ...
    i1_sentirse_desamparada = models.CharField(max_length=100, choices=ESCALA_DEPENDENCIA_EMOCIAL_CHOICES)
    i2_ser_abandonada_pareja = models.CharField(max_length=100, choices=ESCALA_DEPENDENCIA_EMOCIAL_CHOICES)
    i3_deslumbrar_pareja = models.CharField(max_length=100, choices=ESCALA_DEPENDENCIA_EMOCIAL_CHOICES)
    i4_centro_atencion_pareja = models.CharField(max_length=100, choices=ESCALA_DEPENDENCIA_EMOCIAL_CHOICES)
    i5_necesitar_afecto = models.CharField(max_length=100, choices=ESCALA_DEPENDENCIA_EMOCIAL_CHOICES)
    i6_angustia_enojo = models.CharField(max_length=100, choices=ESCALA_DEPENDENCIA_EMOCIAL_CHOICES)
    ...
    k1_dolor_cabeza = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k2_mal_apetito = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k3_mal_dormir = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k4_facil_susto = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k5_temblor_manos = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k6_nervios_sin_causa = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k7_tensa_sin_causa = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k8_aburrida = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k9_mala_digestion = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k10_no_pensar_claro = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k11_triste = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k12_no_disfrutar_diario = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k13_no_disfrutar_trabajo = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k14_dicultad_decisiones = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k15_acabar_vida = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k16_cansada_sin_razon = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k17_sensacion_estomago = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k18_dificultad_diario = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k19_tratado_herirla = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k20_controlar_pensamientos = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k21_escuchar_voces = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k22_tener_convulsiones = models.CharField(max_length=100, choices=ESCALA_NUNCA_A_SIEMPRE_CHOICES, default = "No aplica")
    k23_llora_frecuentemente = models.CharField(max_length=100, choices=ESCALA_MUY_DEACUERDO_MUY_DESACUERDO_CINCO_CHOICES, default = "No aplica")
    k24_util_vida = models.CharField(max_length=100, choices=ESCALA_MUY_DEACUERDO_MUY_DESACUERDO_CINCO_CHOICES, default = "No aplica")
    k25_perdidad_interes = models.CharField(max_length=100, choices=ESCALA_MUY_DEACUERDO_MUY_DESACUERDO_CINCO_CHOICES, default = "No aplica")
    k26_persona_inutil = models.CharField(max_length=100, choices=ESCALA_MUY_DEACUERDO_MUY_DESACUERDO_CINCO_CHOICES, default = "No aplica")
    k27_persona_importante = models.CharField(max_length=100, choices=ESCALA_MUY_DEACUERDO_MUY_DESACUERDO_CINCO_CHOICES, default = "No aplica")
    opinion_dificultad_proceso = models.CharField(max_length=400, default = "No aplica")
    opinion_atencion_terapia = models.CharField(max_length=400, default = "No aplica")
